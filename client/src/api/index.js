...
export const URL = "http://localhost:7100/";
//export const URL = '/'
export const config = {
  headers: {
...
export const getItems = (storeIndex, params) => {
  ...
  return axios.get(URL + "api/" + storeIndex, config);
};
...
export const getItem = (id, storeIndex) => {
  ...
  //if(params)config.params={...config.params,...params}
  return axios.get(URL + "api/" + storeIndex + "/" + id, config);
};
...
export const insertItem = (data, storeIndex, ct) => {
  ...
  return axios.post(URL + "api/" + storeIndex, data, config);
};
...
export const updateItem = (data, storeIndex, ct) => {
  ...
  return axios.put(URL + "api/" + storeIndex + "/" + id, data, config);
};

export const deleteItem = (id, storeIndex) =>
...
export const checkPermission = (storeIndex) => {
  ...
  //if(params)config.params={...config.params,...params}
  return axios.get(URL + "api/permission/" + storeIndex, config);
};
