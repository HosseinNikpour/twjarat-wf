...
const Cardboard = (props) => {
    ...
    const getData = () => {
        ...
        Promise.all([getItems(entityName), getItems('unit')]).then((response) => {
            ...
            setStatus_options([{ key: 1, label: 'تایید', value: 1 }, { key: 2, label: 'عدم تایید', value: 2 }]);
                        ...
                        <form>
                                ...
                                <div className="row">
                                    <div className="col">
                                        <div className="form-group">
                                            ...
                                            <input className="form-control" type="text" value={obj.vw_sender} disabled={true} />
                                        </div>
                                    </div>
                                    <div className="col">
                                        <div className="form-group">
                                            <label className="form-control-label">تاریخ ارسال</label>
                                            <input className="form-control" type="text" value={moment(obj.create_date).format('jYYYY/jMM/jDD')} disabled={true} />
                                        </div>
                                    </div>
                                    <div className="col">
                                        <div className="form-group">
                                            <label className="form-control-label">فایل ارسالی</label>
                                            {obj.sender_file_attachment && <div><a rel="noreferrer" target="_blank" href={obj.sender_file_attachment}>مشاهده فایل</a></div>}
                                        </div>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col">
                                        <div className="form-group">
                                            ...
                                            <textarea rows={3} className="form-control" value={obj.sender_description} disabled={true} />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-4">
                                    ...
                                    <Select id='project' className={errors.status_id ? "form-control error-control" : "form-control"}
                                        {...Static.selectDefaultProp} disabled={mode === 'display'} options={status_options}
                                        value={obj.status_id} onSelect={(values) => setObj({ ...obj, status_id: values })} />
                                </div>
                            </div>
                            {obj.status_id == 1 && <div className="row">
                                <div className="col">
                                    <table className='table table-striped table-bordered' style={{ marginTop: '50px' }}>
                                        <thead>
                                            <tr>
                                                <td width={'20%'}>مدیریت</td><td width={'20%'}>فایل ضمیمه</td><td>توضیحات</td>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            {tableDate.map((a, i) => {
                                                return (
                                                    <tr>
                                                        ...
                                                        <td><input className="form-control" type="file" onChange={(e) => setTableFields(i, 'f_file_attachment', e.target.files[0])} /></td>
                                                        <td><input className="form-control" type="text" onChange={(e) => setTableFields(i, 'description', e.target.value)} /></td>
                                                    </tr>)
                                            })}
                                        </tbody>
                                    </table>
                            ...
                            {obj.status_id > 1 && <div className="row">
                                ...
                                <div className="col">
                                    <div className="form-group">
                                        ...
                                        <textarea rows={3} className={errors.description ? "form-control error-control" : "form-control"} value={obj.description}
