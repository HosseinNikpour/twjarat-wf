...
export const errorMesesagDuplicate =
  "اطلاعات مربوط به این سطر قبلا وارد سیستم شده";
...
export const priority_options = [
  { key: 1, label: "فوری", value: 1 },
  { key: 2, label: "متوسط", value: 2 },
  { key: 3, label: "عادی", value: 3 },
];

export const workload_options = [
  { key: 1, label: "کوچک", value: 1 },
  { key: 2, label: "متوسط", value: 2 },
  { key: 3, label: "بزرگ", value: 3 },
];

export const projectState_options = [
  { key: 1, label: "ثبت درخواست", value: 1 },
...
export const invoiceState_options = [
  { key: 1, label: "ثبت شده", value: 1 },
...
export const response_options = [
  { key: 1, label: "نیازمند بررسی بیشتر", value: 1 },
